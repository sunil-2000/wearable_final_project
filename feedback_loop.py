...
win.title("Gallery")
img1= ImageTk.PhotoImage(Image.open("cancel.png"))
img2=ImageTk.PhotoImage(Image.open("checkmark.jpg"))
img3= ImageTk.PhotoImage(Image.open("chew_talk.jpg"))
img4=ImageTk.PhotoImage(Image.open("masked.png"))
img5= ImageTk.PhotoImage(Image.open("smile.png"))
img6=ImageTk.PhotoImage(Image.open("unmasked.png"))
